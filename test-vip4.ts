...
async function test() {
    ...
    for (const type of req_types) {
        ...
        const payload = JSON.stringify({
            ...
            req: {
                ...
                param: {
                    ...
                    songtype: [0],
                    uin,
                    loginflag: 1, // App might use 1 or 2
                    platform: "20",
        ...
        console.log(`NO qm_keyst + ct=11 + req + ${type.name}:`, JSON.stringify(json, null, 2));
    }
}
