...
async function test() {
    ...
    for (const type of req_types) {
        ...
        console.log(`With O Prefix uin + req + ${type.name}:`, JSON.stringify(json, null, 2));
    }
}
