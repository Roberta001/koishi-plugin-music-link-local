...
async function test() {
    ...
    const req_types = [
        ...
        { name: "M800", filename: `M800${media_mid}.mp3` }
    ];
    ...
    for (const type of req_types) {
        ...
        console.log(`req + ${type.name}:`, JSON.stringify(json, null, 2));
    }
}
